            ...
            <div className="space-y-8">
              <div className="space-y-4">
                <Badge className="bg-blue-100 text-blue-800 border-blue-200">
                  ...
                  เทคโนโลยี AI เพื่อความปลอดภัยบนท้องถนน
                </Badge>
