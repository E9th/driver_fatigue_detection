 ...
 * Removed the dynamic device count to resolve permission issues and simplify the component.
 * Replaced dynamic stat with a static marketing metric.
 */
export function HomePage() {
  ...
  return (
    <div className="bg-white dark:bg-gray-900">
      ...
      <section className="bg-white dark:bg-gray-900 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                <div className="p-4">
                    <div className="text-4xl font-bold text-blue-600">99.5%</div>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">ความแม่นยำในการตรวจจับ</p>
                </div>
                <div className="p-4">
                    <div className="text-4xl font-bold text-green-600">24/7</div>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">ตรวจสอบต่อเนื่อง</p>
                </div>
                <div className="p-4">
                    <div className="text-4xl font-bold text-purple-600">98%</div>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">ความพึงพอใจจากผู้ใช้</p>
                </div>
            </div>
        </div>
      </section>
      ...
      {/* Features Section */}
      <section id="features" className="py-16 lg:py-24 bg-gray-50 dark:bg-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* Pricing Section */}
      <section id="pricing" className="py-16 lg:py-24 bg-gray-50 dark:bg-slate-800">
      ...
      <section id="about" className="py-16 lg:py-24 bg-white dark:bg-gray-900">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center"><div className="mx-auto w-16 h-16 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center mb-6"><Heart className="h-8 w-8 text-white"/></div><h2 className="text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white">เกี่ยวกับเรา</h2><p className="mt-6 text-xl text-gray-700 dark:text-gray-300 max-w-3xl mx-auto">"เรามุ่งมั่นที่จะลดอุบัติเหตุบนท้องถนนที่เกิดจากความเหนื่อยล้าของผู้ขับขี่ ด้วยการพัฒนาเทคโนโลยี AI ที่เข้าถึงง่ายและใช้งานได้จริง เพื่อสร้างมาตรฐานความปลอดภัยใหม่ให้กับการเดินทางทุกรูปแบบ"</p></div>
      </section>
