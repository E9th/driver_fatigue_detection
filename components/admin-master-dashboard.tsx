  ...
  useEffect(() => {
    const loadAllData = async () => {
      ...
      try {
        ...
        // --- FIX: Reverted to the original, working data fetching logic for alerts ---
    ...
    loadAllData();
  }, []); // Changed to [] to ensure it runs only once
  ...
  const handleExportSummary = () => {
    ...
    const htmlContent = `
      ...
      <body>
          <div class="container">
              <div class="header">
                  <h1>รายงานสรุปภาพรวมระบบ</h1><p>ข้อมูล ณ วันที่: ${reportDate}</p><p>ช่วงเวลาที่แสดงผล: ${timeRange}</p>
              </div>
              <h2>สถิติโดยรวม</h2>
              <div class="grid">
